      ...
      onDrop: (acceptedFiles, rejectedFiles) => {
        if (rejectedFiles.length > 0) {
          const fileTypes = rejectedFiles
            ...
            .join(", ");
          setError(
            `Only image files are allowed. Rejected files: ${fileTypes}`
          );
      ...
      onDropRejected: (rejectedFiles) => {
        const errors = rejectedFiles.map((file) => {
          if (file.errors[0].code === "file-invalid-type") {
            return `${file.file.name} is not an image file`;
          }
          ...
          <div className="flex flex-col items-center justify-center space-y-4 sm:space-y-6">
            ...
            >
              ...
              <p className="text-gray-500 text-lg">
                {isDragActive ? "Drop the images here" : "or Drag images here"}
              </p>
              <p className="text-sm text-gray-400 mt-2">
                All image formats are supported (max 10MB)
              </p>
            </div>
