      ...
      onDrop: (acceptedFiles, rejectedFiles) => {
        if (rejectedFiles.length > 0) {
          const fileTypes = rejectedFiles
            ...
            .join(", ");
          setError(`Only PNG files are allowed. Rejected files: ${fileTypes}`);
      ...
      onDropRejected: (rejectedFiles) => {
        const errors = rejectedFiles.map((file) => {
          if (file.errors[0].code === "file-invalid-type") {
            return `${file.file.name} is not a PNG file`;
          }
    ...
    <div className="w-full min-h-screen overflow-hidden relative">
      ...
      <div className="relative z-10">
        <div className="flex flex-col justify-center items-center pt-16 sm:pt-24 md:pt-32 px-4">
          ...
          >
            Convert your PNG images to PDF format with ease
          </motion.p>
              ...
              <div className="flex flex-col items-center justify-center space-y-4 sm:space-y-6">
                ...
                >
                  ...
                  <p className="text-gray-500 text-lg">
                    {isDragActive
                      ? "Drop the PNG images here"
                      : "or Drag PNG files here"}
                  </p>
                  <p className="text-sm text-gray-400 mt-2">
                    Only PNG files are supported (max 10MB)
                  </p>
                </div>
