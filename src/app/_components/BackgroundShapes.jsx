  ...
  return (
    <div className="relative min-h-screen w-full">
      ...
      <div className="fixed inset-0 w-full h-full min-h-screen">
        ...
        <div className="absolute inset-0 w-full h-full bg-gradient-to-br from-indigo-100 via-rose-50 to-teal-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900" />

        {/* Floating Shapes */}
        <FloatingShapes />

        {/* Subtle pattern overlay */}
        <div className="absolute inset-0 w-full h-full opacity-[0.15] dark:opacity-[0.1] z-20">
        ...
        <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-indigo-100/50 to-transparent dark:via-white/5 animate-shimmer" />
      </div>
